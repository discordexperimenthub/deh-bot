module.exports = {
    ...
    AUTOMOD_BAD_CONTENT_DISABLE: 'Disable Bad Content',
    AUTOMOD_BAD_CONTENT_ENABLE: 'Enable Bad Content',
    AUTOMOD_BADCONTENT_ENABLE_SUCCESS: 'Bad Content has been enabled successfully!',
    AUTOMOD_BADCONTENT_DISABLE_SUCCESS: 'Bad Content has been disabled successfully!',
    ...
    BAD_CONTENT_AI_MODEL_SET_SUCCESS: 'Bad Content model has been set as **`{{0}}`** successfully!',
