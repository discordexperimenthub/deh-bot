...
const {
	...
	homeSettings,
	automodAIConfigure,
	automodBadContentConfigure,
	automodToxicContentConfigure,
...
client.on('interactionCreate', async (interaction) => {
	if (interaction.isCommand() || interaction.isContextMenuCommand()) {
		logger(
			...
			'from',
			interaction.guild ? `${interaction.guild.name} (${interaction.guild.id})` : 'DMs',
			'by',
		...
		logger(
			...
			`${interaction.customId} (${interaction.componentType})`,
			'from',
			interaction.guild ? `${interaction.guild.name} (${interaction.guild.id})` : 'DMs',
			'by',
			`${interaction.user.tag} (${interaction.user.id})`,
		...
		try {
			...
			if (userId !== 'everyone' && userId !== interaction.user.id)
				return interaction.reply({
			...
			switch (customId) {
				...
				case 'home_setup':
					...
					if (
						!interaction.appPermissions.has('ManageChannels') ||
						!interaction.appPermissions.has('ManageWebhooks') ||
						!interaction.appPermissions.has('ManageMessages')
					)
						return interaction.followUp({
							content: localize(
								interaction.locale,
								'BOT_MISSING_PERMISSIONS',
								'Manage Channels, Manage Webhooks, Manage Messages',
							),
							ephemeral: true,
						});
				...
				case 'home_toggle':
					...
					await interaction.followUp({
						content: localize(
							locale,
							`SETTING_${home.data.enabled ? 'ENABLE' : 'DISABLE'}_SUCCESS`,
				...
				case 'home_channel_select':
					...
					client.channels.cache
						.get(channelId)
						.send('**There are no Highlights to show you yet!**\nBut you could write some!')
						.catch(() => {});
									...
									messages: [
										{
											role: 'system',
											content:
												'You have to return with an array of rules. Nothing else. Do not include if something is not a rule. Do not break the order of the rules.',
										},
										{
											role: 'user',
											content:
										...
										},
										{
											role: 'user',
											content: messages2
												.filter((m) => m.content || m.embeds[0]?.description)
												.map((m) => (m.content === '' ? m.embeds[0]?.description : ''))
												.join('\n'),
										},
									],
								},
				...
				case 'automod_toggle':
					...
					await interaction.followUp({
						content: localize(
							locale,
							`AUTOMOD_${category.toLocaleUpperCase()}_${
								automod.data[category].enabled ? 'ENABLE' : 'DISABLE'
							}_SUCCESS`,
							localize(locale, 'AUTOMOD'),
						),
						ephemeral: true,
					});
								...
								new StringSelectMenuBuilder()
									...
									.setOptions(
										new StringSelectMenuOptionBuilder()
											...
											.setValue('sexual')
											.setDefault(
												automod.data.badContent.filters === 'all' || automod.data.badContent.filters.includes('sexual'),
											),
										new StringSelectMenuOptionBuilder()
											.setLabel(localize(locale, 'HATE'))
											.setValue('hate')
											.setDefault(
												automod.data.badContent.filters === 'all' || automod.data.badContent.filters.includes('hate'),
											),
										new StringSelectMenuOptionBuilder()
											...
											.setDefault(
												automod.data.badContent.filters === 'all' ||
													automod.data.badContent.filters.includes('harassment'),
											),
										new StringSelectMenuOptionBuilder()
											...
											.setDefault(
												automod.data.badContent.filters === 'all' ||
													automod.data.badContent.filters.includes('self-harm'),
											),
										new StringSelectMenuOptionBuilder()
											...
											.setDefault(
												automod.data.badContent.filters === 'all' ||
													automod.data.badContent.filters.includes('sexual/minors'),
											),
										new StringSelectMenuOptionBuilder()
											...
											.setDefault(
												automod.data.badContent.filters === 'all' ||
													automod.data.badContent.filters.includes('hate/threatening'),
											),
										new StringSelectMenuOptionBuilder()
											...
											.setDefault(
												automod.data.badContent.filters === 'all' ||
													automod.data.badContent.filters.includes('violence/graphic'),
											),
										new StringSelectMenuOptionBuilder()
											...
											.setDefault(
												automod.data.badContent.filters === 'all' ||
													automod.data.badContent.filters.includes('self-harm/intent'),
											),
										new StringSelectMenuOptionBuilder()
											...
											.setDefault(
												automod.data.badContent.filters === 'all' ||
													automod.data.badContent.filters.includes('self-harm/instructions'),
											),
										new StringSelectMenuOptionBuilder()
											...
											.setDefault(
												automod.data.badContent.filters === 'all' ||
													automod.data.badContent.filters.includes('harassment/threatening'),
											),
										new StringSelectMenuOptionBuilder()
											...
											.setDefault(
												automod.data.badContent.filters === 'all' ||
													automod.data.badContent.filters.includes('violence'),
											),
									)
									.setMaxValues(11),
							),
										...
										new StringSelectMenuOptionBuilder()
											...
											.setDefault(
												automod.data.toxicContent.filters === 'all' ||
													automod.data.toxicContent.filters.includes('toxicity'),
											),
										new StringSelectMenuOptionBuilder()
											...
											.setDefault(
												automod.data.toxicContent.filters === 'all' ||
													automod.data.toxicContent.filters.includes('severe-toxicity'),
											),
										new StringSelectMenuOptionBuilder()
											...
											.setDefault(
												automod.data.toxicContent.filters === 'all' ||
													automod.data.toxicContent.filters.includes('identity-attack'),
											),
										new StringSelectMenuOptionBuilder()
											...
											.setDefault(
												automod.data.toxicContent.filters === 'all' ||
													automod.data.toxicContent.filters.includes('insult'),
											),
										new StringSelectMenuOptionBuilder()
											...
											.setDefault(
												automod.data.badContent.filters === 'all' ||
													automod.data.toxicContent.filters.includes('profanity'),
											),
										new StringSelectMenuOptionBuilder()
											...
											.setDefault(
												automod.data.toxicContent.filters === 'all' ||
													automod.data.toxicContent.filters.includes('threat'),
											),
									)
									.setMaxValues(6),
							),
				...
				case 'clyde_private_channel':
					...
					if (interaction.guildId !== '1086707622759125053')
						return interaction.editReply(localize(locale, 'COMPONENT_NOT_AVAILABLE', localize(locale, 'SERVER')));
					...
					if (!dehMember.roles.cache.has('1150833323267084359') && !developerIds.includes(interaction.user.id))
						return interaction.editReply(localize(locale, 'ACTION_REQUIRES_TIER_1'));
					if (await db.get(`clyde.${interaction.user.id}.privateChannel`))
						return interaction.editReply(localize(locale, 'PRIVATE_CHANNEL_ALREADY_EXISTS'));
				...
				case 'clyde_private_add':
					...
					if (args[0] === 'selected') {
						...
						return interaction.editReply(
							localize(locale, 'ADD_MEMBERS_SUCCESS', members.map((id) => `<@${id}>`).join(', ')),
						);
					} else
							...
							components: [
								new ActionRowBuilder().setComponents(
									new UserSelectMenuBuilder()
										...
										.setMaxValues(
											interaction.guild.members.cache.size > 25 ? 25 : interaction.guild.members.cache.size,
										),
								),
							],
						});
				...
				case 'clyde_private_remove':
					...
					if (args[0] === 'selected') {
						...
						return interaction.editReply(
							localize(locale, 'REMOVE_MEMBERS_SUCCESS', members.map((id) => `<@${id}>`).join(', ')),
						);
					} else
						interaction.editReply({
							components: [
		...
		try {
			...
			switch (customId) {
				...
				case 'automod_bad_content_test_modal':
					...
					interaction.editReply(
						`${localize(locale, 'BAD_CONTENT_FILTER_RESPONSE')}\n${result2 ?? localize(locale, 'API_IS_DOWN')}`,
					);
					break;
				case 'automod_toxic_content_test_modal':
					...
					interaction.editReply(
						`${localize(locale, 'TOXIC_CONTENT_FILTER_RESPONSE')}\n${result3 ?? localize(locale, 'API_IS_DOWN')}`,
					);
					break;
...
client.on('messageCreate', async (message) => {
	...
	if (message.content.toLowerCase().includes('real')) {
		...
		if (message.guildId === '1089540433010491392')
			await message
				.reply(`You have said real **${user.real}** times.`)
